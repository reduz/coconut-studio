...
KeyBind::KeyBind() {
	...
	key_binds[KB_PATTERN_CURSOR_NOTE_OFF].description="Pattern - Insert Note Off";
	...
	key_binds[KB_PATTERN_BLOCK_RAMP_VALUES].description="Pattern - Block Ramp Volumes/Numbers";
	...
	key_binds[KB_UNDO].description="Application - Undo";
	key_binds[KB_REDO].description="Application - Redo";
	key_binds[KB_QUIT].description="Application - Quit";
